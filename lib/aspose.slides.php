...
class PresentationLockingBehavior extends Java {
	...
	const KeepLocked = 1;
	const LoadAndRelease_Legacy_TemporaryDefault = 255;
	const EnumSeparatorCharArray = ",";
...
class EffectSubtype extends Java {
	...
	const Center = 5;
	const Clockwise = 6;
	const CounterClockwise = 7;
	const GradualAndCycleClockwise = 8;
	const GradualAndCycleCounterClockwise = 9;
	const Down = 10;
	const DownLeft = 11;
	const DownRight = 12;
	const FontAllCaps = 13;
	const FontBold = 14;
	const FontItalic = 15;
	const FontShadow = 16;
	const FontStrikethrough = 17;
	const FontUnderline = 18;
	const Gradual = 19;
	const Horizontal = 20;
	const HorizontalIn = 21;
	const HorizontalOut = 22;
	const In = 23;
	const InBottom = 24;
	const InCenter = 25;
	const InSlightly = 26;
	const Instant = 27;
	const Left = 28;
	const OrdinalMask = 29;
	const Out = 30;
	const OutBottom = 31;
	const OutCenter = 32;
	const OutSlightly = 33;
	const Right = 34;
	const Slightly = 35;
	const Top = 36;
	const TopLeft = 37;
