...
class SensitivityLabel extends Java {
	static private $_className = "com.aspose.slides.SensitivityLabel";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
...
class SensitivityLabelContentType extends Java {
	const None = 0;
	const Header = 1;
	const Footer = 2;
	const Watermark = 4;
	const Encryption = 8;
	const EnumSeparatorCharArray = ",";
	static private $_className = "com.aspose.slides.SensitivityLabelContentType";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
class CompressionLevel extends Java {
	const None = 0;
	const Level1 = 1;
	const Level2 = 2;
	const Level3 = 3;
	...
	const Level9 = 9;
	const EnumSeparatorCharArray = ",";
	static private $_className = "com.aspose.slides.CompressionLevel";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
...
class SensitivityLabelAssignmentType extends Java {
	const Standard = 0;
	const Privileged = 1;
	const EnumSeparatorCharArray = ",";
	static private $_className = "com.aspose.slides.SensitivityLabelAssignmentType";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
...
class FontStyleType extends Java {
	const Regular = 0;
	const Bold = 1;
	const Italic = 2;
	const Underline = 4;
	const Strikeout = 8;
	const EnumSeparatorCharArray = ",";
	static private $_className = "com.aspose.slides.FontStyleType";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
...
class ShapeAdjustmentType extends Java {
	const Custom = 0;
	const CornerSize = 1;
	const LeftUpCorner = 2;
	const RightUpCorner = 3;
	const UpCorners = 4;
	const DownCorners = 5;
	const Thickness = 6;
	const ArrowTailThickness = 7;
	const ArrowheadLength = 8;
	const ArrowheadWidth = 9;
	const Radius = 10;
	const Depth = 11;
	const ShapePartOffset = 12;
	const Angle = 13;
	const StartAngle = 14;
	const EndAngle = 15;
	const StartPointX = 16;
	const StartPointY = 17;
	const ConnectorPoint1X = 18;
	const ConnectorPoint1Y = 19;
	const ConnectorPoint2X = 20;
	const ConnectorPoint2Y = 21;
	const ConnectorBendPositionX = 22;
	const ConnectorBendPositionY = 23;
	const AttachY = 24;
	const AttachX = 25;
	const CalloutHeight = 26;
	const CalloutWidth = 27;
	const CalloutSize = 28;
	const Curvature = 29;
	const HorizontalThickness = 30;
	const VerticalThickness = 31;
	const VerticalSize = 32;
	const HorizontalSize = 33;
	const Top = 34;
	const EnumSeparatorCharArray = ",";
	static private $_className = "com.aspose.slides.ShapeAdjustmentType";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
...
class Merger extends Java {
	static private $_className = "com.aspose.slides.Merger";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
	static function process(...$argv) {
		return Java(self::$_className)->process(...$argv);
	}
}
...
class Ink extends Java {
	...
	static function getInkEffectImages(...$argv) {
		return Java(self::$_className)->getInkEffectImages(...$argv);
	}
}
...
class BrightnessContrast extends Java {
	static private $_className = "com.aspose.slides.BrightnessContrast";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
...
class MathPhantom extends Java {
	static private $_className = "com.aspose.slides.MathPhantom";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
...
class WorkbookType extends Java {
	const NotDefined = -1;
	const Workbook = 0;
	const WorkbookMacro = 1;
	const Template = 2;
	const TemplateMacro = 3;
	const WorkbookBinaryMacro = 4;
	const EnumSeparatorCharArray = ",";
	static private $_className = "com.aspose.slides.WorkbookType";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
...
class SlidesAIAgent extends Java {
	static private $_className = "com.aspose.slides.SlidesAIAgent";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
...
class ExcelDataCell extends Java {
	static private $_className = "com.aspose.slides.ExcelDataCell";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
...
class InkEffectType extends Java {
	const NotDefined = -1;
	const Bronze = 0;
	const Galaxy = 1;
	const Gold = 2;
	const Lava = 3;
	const Ocean = 4;
	const RainbowGlitter = 5;
	const RoseGold = 6;
	const Silver = 7;
	const EnumSeparatorCharArray = ",";
	static private $_className = "com.aspose.slides.InkEffectType";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
...
class ExcelDataWorkbook extends Java {
	static private $_className = "com.aspose.slides.ExcelDataWorkbook";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
...
class ExcelWorkbookImporter extends Java {
	static private $_className = "com.aspose.slides.ExcelWorkbookImporter";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
	static function addChartFromWorkbook(...$argv) {
		return Java(self::$_className)->addChartFromWorkbook(...$argv);
	}
	static function addTableFromWorkbook(...$argv) {
		return Java(self::$_className)->addTableFromWorkbook(...$argv);
	}
}
...
class PresentationContentAmountType extends Java {
	const Brief = 0;
	const Medium = 1;
	const Detailed = 2;
	const EnumSeparatorCharArray = ",";
	static private $_className = "com.aspose.slides.PresentationContentAmountType";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
...
class HandleRepeatedSpaces extends Java {
	const None = 0;
	const AlternateSpacesToNbsp = 1;
	const MultipleSpacesToNbsp = 2;
	const EnumSeparatorCharArray = ",";
	static private $_className = "com.aspose.slides.HandleRepeatedSpaces";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
...
class OpenAIWebClient extends Java {
	static private $_className = "com.aspose.slides.OpenAIWebClient";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
...
class Convert extends Java {
	...
	static function toTiff(...$argv) {
		return Java(self::$_className)->toTiff(...$argv);
	}
	static function toSvg(...$argv) {
		return Java(self::$_className)->toSvg(...$argv);
	}
	static function toJpeg(...$argv) {
		return Java(self::$_className)->toJpeg(...$argv);
	}
	...
	static function toPng(...$argv) {
		return Java(self::$_className)->toPng(...$argv);
	}
}
...
class SlideUtil extends Java {
	...
	static function toSaveFormat(...$argv) {
		return Java(self::$_className)->toSaveFormat(...$argv);
	}
	static function getAllTextFrames(...$argv) {
		return Java(self::$_className)->getAllTextFrames(...$argv);
	}
	static function findShapesByPlaceholderType(...$argv) {
		return Java(self::$_className)->findShapesByPlaceholderType(...$argv);
	}
	static function findAndReplaceText(...$argv) {
		return Java(self::$_className)->findAndReplaceText(...$argv);
	}
	static function getTextBoxesContainsText(...$argv) {
		return Java(self::$_className)->getTextBoxesContainsText(...$argv);
	}
}
class SlidesAIAgentException extends Java {
	static private $_className = "com.aspose.slides.SlidesAIAgentException";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
...
class SensitivityLabelCollection extends Java {
	static private $_className = "com.aspose.slides.SensitivityLabelCollection";
	function __construct(...$argv) {
		parent::__construct(self::$_className, ...$argv);
	}
}
